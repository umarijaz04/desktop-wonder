...
namespace AhmadSanitary
{
    public partial class Purchases_Return : Form
    {
        ...
        private void entercartdata()
        {
            ...
            //                {
            //                    dr5.Close();
            //                    MessageBox.Show("This Product Already Exist in Purchases Return Cart", "WONDER PLASTIC INDUSTRY", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            //                }
            //                else
            //                {
            //                    dr5.Close();
            ...
            if (e.KeyCode == Keys.Enter)
            {
                if (txtsinvoice.Text != "")
                {
                    if (Convert.ToDecimal(txtsinvoice.Text) != 0)
                    {
                        ...
                        {
                            dr.Close();
                            MessageBox.Show("Purchase Return No Already Exist", "WONDER PLASTIC INDUSTRY", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                            txtsinvoice.Clear();
                            txtsinvoice.Focus();
                            sinvoice = false;
                            btnsubmit.Enabled = false;
        ...
        private void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            //}
            Login.con.Close();
            MessageBox.Show("Purchases Return Inserted Successfully", "WONDER PLASTIC INDUSTRY", MessageBoxButtons.OK, MessageBoxIcon.Information);
            reset_cart();
        }
