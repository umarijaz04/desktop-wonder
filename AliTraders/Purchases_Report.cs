...
namespace AhmadSanitary
{
    public partial class Purchases_Report : Form
    {
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (delid != "")
            {
                DialogResult dresult = MessageBox.Show("Are you sure you want to delete this DC No", "WONDER PLASTIC INDUSTRY", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dresult == DialogResult.OK)
                {
                    try
                    {
                        ...
                        delid = "";
                        Login.con.Close();
                        MessageBox.Show("DC Deleted Successfully", "WONDER PLASTIC INDUSTRY", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        btnsearch_Click(this, null);
                    }
                    catch (Exception)
                    {
                        MessageBox.Show("First Delete Purchases Return & Breakage Against This Sales Invoice", "WONDER PLASTIC INDUSTRY", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
        }
