...
namespace AhmadSanitary
{
    public partial class Login : Form
    {
        ...
        //public static SqlConnection con = new SqlConnection("server=localhost\\sa,1433; database=veronati_hassan; Integrated Security=False; Connect Timeout=180; User ID=sa; Password=123456");
        //public static SqlConnection con = new SqlConnection("server=69.162.125.10; database=veronati_shani; Integrated Security=False; Connect Timeout=180; User ID=veronati_admin; Password=GalaxyA32016");
        //public static SqlConnection con = new SqlConnection("server=DESKTOP-48EUQOB\\SQLEXPRESS; database=Inventory; Integrated Security=True; Connect Timeout=180;");
        public static SqlConnection con = new SqlConnection("server=Wonder-PC; database=Inventory; Integrated Security=True; Connect Timeout=180;");
